...
char *compute_get_request(char *host, char *url, char *query_params,
                            char **cookies, int cookies_count, bool usedToken, const char* token)
{
...
char *compute_delete_request(char *host, char *url, char *query_params,
                             char **cookies, int cookies_count, bool usedToken, const char* token) {char *message = (char *) calloc(BUFLEN, sizeof(char));
	char *line = (char *) calloc(LINELEN, sizeof(char));
...
char *compute_post_request(char *host, char *url, char* content_type, char **body_data,
                            int body_data_fields_count, char **cookies, int cookies_count, bool usedToken, const char* token)
{
    char *message = (char *) calloc(BUFLEN, sizeof(char));
    char *line = (char *) calloc(LINELEN, sizeof(char));
